...
int main(){
    ...
    Shader shader("../07_coordinate_systems/_vert.glsl", "../07_coordinate_systems/_frag.glsl");
    ...
    //texture
    int w1, h1, c1;
    unsigned char *data1 = stbi_load("../07_coordinate_systems/texture1.png", &w1, &h1, &c1, 0);
    assert(data1);

    int w2, h2, c2;
    unsigned char *data2 = stbi_load("../07_coordinate_systems/texture2.png", &w2, &h2, &c2, 0);
    assert(data2);
